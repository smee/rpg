...
trainingFitnessE20 <- makeRegressionFitnessFunction(FillLevel ~ Rainfall + Rainfall.P1 + Rainfall.P2 + Rainfall.P3 + Rainfall.P4 + Rainfall.P5 + Rainfall.P6 + Rainfall.P7 + Rainfall.P8 + Rainfall.P9 + Rainfall.P10 + Rainfall.P11 + Rainfall.P12 + Rainfall.P13 + Rainfall.P14 + Rainfall.P15 + Rainfall.P16 + Rainfall.P17 + Rainfall.P18 + Rainfall.P19 + Rainfall.P20, trainingDataE20)
testFitnessE20 <- makeRegressionFitnessFunction(FillLevel ~ Rainfall + Rainfall.P1 + Rainfall.P2 + Rainfall.P3 + Rainfall.P4 + Rainfall.P5 + Rainfall.P6 + Rainfall.P7 + Rainfall.P8 + Rainfall.P9 + Rainfall.P10 + Rainfall.P11 + Rainfall.P12 + Rainfall.P13 + Rainfall.P14 + Rainfall.P15 + Rainfall.P16 + Rainfall.P17 + Rainfall.P18 + Rainfall.P19 + Rainfall.P20, testDataE20)
