...
#1d
pop1 <- .Call("evolutionRun", Runs = 100000, popsize= 200,selectionsize = 20, actualParameters= x, targetValues= y, funcset= c("+","-","*","/","sin","cos","tan","sqrt","exp","log"),inset=c("x"),maxdepth= 7, maxleafs= 20, maxNodes= 20, constprob= 0.3, constScaling= 5, subtreeprob= 0.5, rmselimit= 0, Returnrmse= 0, silent= 0)

#2d
pop1 <- .Call("evolutionRun", Runs = 10000, popsize= 200,selectionsize = 20, actualParameters= xM, targetValues= z, funcset= c("+","-","*","/","sin","cos","tan","sqrt","exp","log"),inset=c("x1","x2"),maxdepth= 7, maxleafs= 20, maxNodes= 20, constprob= 0.3, constScaling= 5, subtreeprob= 0.7, rmselimit= 0, Returnrmse= 0, silent= 0)
